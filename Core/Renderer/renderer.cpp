...
Texture CreateTexture(int width, int height) {
  ...
  glTexParameteri(result.Handle, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
  glTexParameteri(result.Handle, GL_TEXTURE_MAG_FILTER, GL_NEAREST);

  glTexParameteri(result.Handle, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
  glTexParameteri(result.Handle, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
